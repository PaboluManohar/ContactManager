...
public class User {
	...
	public String toString() {
		return "User [id=" + id + ", name=" + name + ", email=" + email + ", password=" + password + ", role=" + role
				+ ", enabled=" + enabled + ", imageUrl=" + imageUrl + ", about=" + about + ", contacts=" + contacts.stream().map(c->c.getName()).collect(Collectors.toList())
				+ "]";
	}
	...
	@Column(length = 100)
	@Size(min = 2,max = 200,message = "min is 2 and max is 200")
